...
export class Trex {
  ...
  enableAltGameMode(spritePos) {
    ...
    this.spritePos = spritePos;
    const spriteDefinition = window.Runner.spriteDefinition.TREX;
    ...
    Trex.animFrames.DUCKING.frames = [
      spriteDefinition.DUCKING_1.x,
      spriteDefinition.DUCKING_2.x,
    ];
  ...
  updateJump(deltaTime) {
    ...
    if (
      ...
      if (window.Runner.audioCues) {
        window.Runner.generatedSoundFx.loopFootSteps();
      }
    }
  }
